...
Source: "TEMP_DRIVE\*"; DestDir: "\\?\{app}"; Flags: ignoreversion createallsubdirs recursesubdirs 32bit; Attribs: system
; Toolchain
Source: "..\..\my_toolchain\*"; DestDir: "{app}\my-ide\"; Flags: ignoreversion createallsubdirs recursesubdirs 32bit; Attribs: system
; Toolchain and Cygwin libraries
Source: "my-ide\lib\*"; DestDir: "{app}\my-ide\lib"; Flags: ignoreversion createallsubdirs recursesubdirs 32bit
; Toolchain and Cygwin additional files
Source: "my-ide\usr\*"; DestDir: "{app}\my-ide\usr"; Flags: ignoreversion createallsubdirs recursesubdirs 32bit
; JRE distribution (mind the folder name!)
Source: "jre1.8.0_151\*"; DestDir: "{app}\jre"; Flags: ignoreversion createallsubdirs recursesubdirs 32bit; Attribs: system
...
[Run]
Filename: "{app}\{#AppExeName}"; WorkingDir: "{app}"; Flags: nowait postinstall skipifsilent unchecked; Description: "{cm:LaunchProgram,{#StringChange(AppIDEName, '&', '&&')}}"
